   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="col-md-3">
        ...
        <header class="jumbotranHist hero-spacer">
            <img class="img-responsive" style= "no-repeat center center" src="../TSLphoto/waterfallMain.jpg" width="840" height="400" alt="">
        </header>
       ...
       <!-- Limiting description length retrived by words -->
        ...
        <div class="row text-center">
            ...
            <br/>
            <?php
                $query = "select * from places WHERE category = 'Waterfall hunting' order by rand() limit 4  ";
