...
<a href="adventure.php" class="list-group-item">Adventure</a>
        ...
        <header class="jumbotranHist hero-spacer">
            <img class="img-responsive" style= "no-repeat center center" src="../TSLphoto/climateMain.jpg" width="840" height="400" alt="">
        </header>
        ...
        <div class="row text-center">
            <h3>What climate do you prefer</h3>
            <br/>
            <?php
                $query = "select * from places WHERE category = 'climate' order by rand() limit 4  ";
