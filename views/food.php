   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="col-md-3">
        ...
        <header class="jumbotronHist hero-spacer">
            <img class="img-responsive" style= "no-repeat center center" src="../TSLphoto/foods.jpg" width="840" height="400" alt="">
        </header>
        ...
        <div class="row text-center">
            <h3>What is your choice of food</h3>
            <br/>
            <?php
                $query = "select * from places WHERE category = 'food' order by rand() limit 4  ";
